...
function AdminMenu() {
  ...
  return <div className="space-y-6">
    ...
    <Modal open={itemModal !== null} onClose={closeItemModal} title={itemModal === "edit" ? `Edit ${editingItem?.name ?? "menu item"}` : "Add menu item"}>
      <MenuItemForm values={form} onChange={setForm} onSubmit={() => itemModal === "edit" ? updateMutation.mutate() : createMutation.mutate()} submitting={saving} submitLabel={itemModal === "edit" ? "Save changes" : "Add item"} />
    </Modal>
