...
function AdminMenu() {
  ...
  const refreshMenu = () => { void queryClient.invalidateQueries({ queryKey: ["admin-menu"] }); void queryClient.invalidateQueries({ queryKey: ["menu"] }); void queryClient.invalidateQueries({ queryKey: ["categories"] }); };
