        ...
        <ul className="hidden items-center gap-1 lg:flex">
          ...
          {isAdmin ? (
            <li>
              <Link
                to="/admin"
                className="flex items-center gap-1.5 rounded-full px-4 py-2 text-sm font-medium text-accent transition-colors hover:bg-accent/10"
              >
            ...
            <AnimatePresence>
              {count > 0 ? (
                <motion.span
                  ...
                  className="absolute -top-0.5 -right-0.5 flex min-w-5 items-center justify-center rounded-full bg-amber-gradient px-1.5 py-0.5 text-[0.65rem] font-bold text-accent-foreground"
                >
                  {count}
                </motion.span>
              ) : null}
        ...
        {mobileOpen ? (
          ...
          >
            <ul className="container-page flex flex-col gap-1 py-4">
              ...
              {isAdmin ? (
                <li>
                  <Link to="/admin" className="block rounded-xl px-4 py-3 text-base font-medium text-accent">
                    Admin dashboard
                  </Link>
                </li>
              ) : null}
